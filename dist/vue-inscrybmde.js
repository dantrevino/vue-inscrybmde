(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("inscrybmde"), require("marked"));
	else if(typeof define === 'function' && define.amd)
		define("VueInscrybMDE", ["inscrybmde", "marked"], factory);
	else if(typeof exports === 'object')
		exports["VueInscrybMDE"] = factory(require("inscrybmde"), require("marked"));
	else
		root["VueInscrybMDE"] = factory(root["InscrybMDE"], root["marked"]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_inscrybmde__ = __webpack_require__(9);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    initialize: function initialize() {
      ...
      // 实例化编辑器
      this.inscrybmde = new __WEBPACK_IMPORTED_MODULE_0_inscrybmde___default.a(configs);
    ...
    bindingEvents: function bindingEvents() {
      ...
      this.inscrybmde.codemirror.on('change', function () {
        _this.$emit('input', _this.inscrybmde.value());
      });
    },
    addPreviewClass: function addPreviewClass(className) {
      var wrapper = this.inscrybmde.codemirror.getWrapperElement();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_734847c2_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_markdown_editor_vue__ = __webpack_require__(11);
var disposed = false
...
var update = __webpack_require__(6)("07a856e7", content, false, {});
